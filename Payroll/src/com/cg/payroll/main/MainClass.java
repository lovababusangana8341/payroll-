...
public class MainClass {
	...
	public static void main(String[] args) {
		//try	{
			...
			Associate associate = new Associate (80000,"Ashish","Sharma","Software Associate","Con","HAEADF645","ashish.sharma@gmail.com",Salary(50000,1000,1000),Bank(452156542,"ICICI","ICICI51565"));
